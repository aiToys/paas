    ...
    <template #dropdown>
      <el-dropdown-menu class="notice-dropdown">
        <div class="notice-header">
          <span>{{ t('notice.center.title') }}</span>
          <el-button
            type="primary"
            link
            size="small"
          ...
          >
            ...
            >
              ...
              <el-empty
                ...
                :description="t('notice.center.emptyAnnouncement')"
                :image-size="80"
              />
            </div>
          </el-tab-pane>
          ...
          >
            ...
            >
              ...
              <el-empty
                ...
                :description="t('notice.center.emptyNotice')"
                :image-size="80"
              />
            </div>
          </el-tab-pane>
          ...
          >
            ...
            >
              ...
              <el-empty
                ...
                :description="t('notice.center.emptyTodo')"
                :image-size="80"
              />
            </div>
          </el-tab-pane>
    ...
    >
      <div class="notice-detail">
        <div class="detail-meta">
          ...
          <span>{{ t('notice.center.publisher') }}：{{ currentNotice?.publisher }}</span>
          <span>{{ t('notice.center.publishTime') }}：{{ currentNotice?.publishTime }}</span>
        </div>
