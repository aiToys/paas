<template>
  ...
  <BuildRunDrawer v-model="detailVisible" :id="detailId" />
</template>
...
import BuildRunDrawer from './BuildRunDrawer.vue'
...
const columns = computed<ColumnDef[]>(() => [
  ...
  { prop: 'startedAt', label: '开始时间', width: 180, formatter: tableTimeFormatter },
  { prop: 'detail', label: '操作', width: 100, slot: 'detail', hideable: false }
])

const detailVisible = ref(false)
const detailId = ref('')
const openDetail = (row: AdminBuildRun) => {
