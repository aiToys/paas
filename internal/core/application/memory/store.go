...
func (s *Store) BindResource(_ context.Context, id, resourceType, name string) (application.Application, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *Store) Unbind(_ context.Context, id, resourceType, name string) (application.Application, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
	a, ok := s.apps[id]
	if !ok {
...
func seed() []application.Application {
	return []application.Application{
		{
			ID: "app-cs", Name: "智能客服", Initial: "客", Env: "生产", Status: "healthy",
		...
		{
			ID: "app-rec", Name: "推荐服务", Initial: "推", Env: "生产", Status: "healthy",
		...
		{
			ID: "app-etl", Name: "数据导入", Initial: "数", Env: "预发", Status: "degraded",
		...
		{
			ID: "app-lab", Name: "实验沙盒", Initial: "沙", Env: "开发", Status: "idle",
		...
		{
			ID: "app-agent", Name: "智能体平台", Initial: "体", Env: "开发", Status: "healthy",
